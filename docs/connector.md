...
sign up at [bookipi.com](https://bookipi.com).
...
sign-in page (`auth.bookipi.com`). Sign in there and you're done. There is no
API key to copy and no software to install; the connector never sees your
password. If your account has more than one company, tell Claude which one to
